    ...
    <div className="">
      <div className="pt-[5rem] pb-0 md:py-[5rem] 2xl:py-[9rem] h-fit  relative overflow-hidden">
        ...
        <Link
          ...
          className="mx-auto mt-10 w-fit  rounded-lg  bg-gradient-to-r from-[#000] to-[#0dc27c] hover:scale-105 border-2 py-1.5 sm:py-2.5 px-8 sm:px-14 border-[#0dc27c] text-white relative z-40 text-lg font-semibold transition-all block"
          target="_blank"
          download
        >
          Hire Now!
        ...
        <Image
          ...
          height={50}
          alt="hero-mask"
          className="hidden sm:block absolute -bottom-[10%] 2xl:-bottom-[5%] -right-[15%] 2xl:-right-[10%]  m-auto h-min w-1/2 z-50"
        />
      </div>
    </div>
  );
