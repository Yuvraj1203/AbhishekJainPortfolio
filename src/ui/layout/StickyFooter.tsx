...
import FooterStripe from "../common/FooterStripe";
...
const StickyFooter = () => {
  ...
  return (
    <>
      <div
        className={`md:hidden fixed  left-0 right-0 m-auto flex w-full flex-col gap-2 rounded-lg z-40 transition-all ${isScrolling ? "bottom-0" : "-bottom-20"}`}
      >
        <div className="flex items-between justify-between w-[95%] m-auto">
          {touchStart ? "" : ""}
          <Link
