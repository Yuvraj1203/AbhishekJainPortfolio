    ...
    <div className="border- rounded-lg ">
      ...
      >
        ...
        <div className="w-full p-2">
          ...
          <p className="text-xs sm:text-sm font-medium text-[#737373] my-1">
            {projectDuration}
          </p>
          <p className="text-xs sm:text-sm text-[#737373] my-4">
            {aboutProject}
          </p>
          ...
          <Link
            href={webUrl}
            className="flex gap-1 items-center capitalize bg-black  rounded-md py-1.5 px-4 text-white w-fit text-sm hover:scale-105 transition-all"
          >
            <span>
              <svg
